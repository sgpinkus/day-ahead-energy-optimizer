...
import { RunSpec, PolyToNumberRunSpecAdaptor, type IRunSpec } from '@/model/RunSpec';
...
const costSpecView: Ref<IRunSpec<number>> = ref(new PolyToNumberRunSpecAdaptor(costSpec.value));
