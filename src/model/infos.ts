...
export const info = {
  ...
  TemperatureRangeCareFactor: 'The cost gradient (price) is 1 when the actual temperature is this number away from desired temperature. If you dont care about the temperature at a given time set this to a very high number (example 100 means practically dont care).',
