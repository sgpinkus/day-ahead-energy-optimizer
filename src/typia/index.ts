...
export const assertEqualsIBusExport = (() => { const _iv2 = new Set([1, 2, 3, 4, 5, 6, 10, 15, 20, 30, 60]); const _iv3 = new Set([1, 2, 3, 4, 5, 6, 10, 15, 20, 30, 60]); const _av5 = new Set([1, 2, 3, 4, 5, 6, 10, 15, 20, 30, 60]); const _av6 = new Set([1, 2, 3, 4, 5, 6, 10, 15, 20, 30, 60]); const _io0 = (input: any): boolean => (undefined === input.devices || Array.isArray(input.devices) && input.devices.every((elem: any) => "object" === typeof elem && null !== elem && _io1(elem))) && (undefined === input.id || "string" === typeof input.id) && (undefined === input.parentId || "string" === typeof input.parentId) && (undefined === input.basis || "number" === typeof input.basis) && (undefined === input.intervalMinutes || true === _iv2.has(input.intervalMinutes)) && (undefined === input.startIntervalOffset || "number" === typeof input.startIntervalOffset) && (undefined === input.title || "string" === typeof input.title) && (undefined === input.type || "string" === typeof input.type) && (undefined === input.attrs || "object" === typeof input.attrs && null !== input.attrs && false === Array.isArray(input.attrs) && _io2(input.attrs)) && (undefined === input.description || "string" === typeof input.description) && (undefined === input.color || "string" === typeof input.color) && (undefined === input.shape || "string" === typeof input.shape) && (undefined === input.tags || "object" === typeof input.tags && null !== input.tags && false === Array.isArray(input.tags) && _io8(input.tags)); const _io1 = (input: any): boolean => "string" === typeof input.id && (undefined === input.parentId || "string" === typeof input.parentId) && ("fixed_load" === input.type || "load" === input.type || "supply" === input.type || "storage" === input.type || "thermal_load" === input.type) && ("object" === typeof input.attrs && null !== input.attrs && false === Array.isArray(input.attrs) && _io2(input.attrs)) && "number" === typeof input.basis && true === _iv3.has(input.intervalMinutes) && "number" === typeof input.startIntervalOffset && (Array.isArray(input.hardBounds) && (input.hardBounds.length === 2 && "number" === typeof input.hardBounds[0] && "number" === typeof input.hardBounds[1])) && ("object" === typeof input.bounds && null !== input.bounds && _io3(input.bounds)) && (undefined === input.cumulative_bounds || "object" === typeof input.cumulative_bounds && null !== input.cumulative_bounds && _io3(input.cumulative_bounds)) && ("object" === typeof input.costs && null !== input.costs && false === Array.isArray(input.costs) && _io5(input.costs)) && (undefined === input.title || "string" === typeof input.title) && (undefined === input.description || "string" === typeof input.description) && ("object" === typeof input.tags && null !== input.tags && false === Array.isArray(input.tags) && _io8(input.tags)) && (undefined === input.color || "string" === typeof input.color) && (undefined === input.shape || "string" === typeof input.shape) && ("object" === typeof input.parameters && null !== input.parameters && false === Array.isArray(input.parameters) && _io9(input.parameters)); const _io2 = (input: any): boolean => (undefined === input.isSupply || "boolean" === typeof input.isSupply) && (undefined === input.hasParameters || "boolean" === typeof input.hasParameters) && (undefined === input.hideBounds || "boolean" === typeof input.hideBounds) && (undefined === input.hideCBounds || "boolean" === typeof input.hideCBounds) && (undefined === input.hideCosts || "boolean" === typeof input.hideCosts); const _io3 = (input: any): boolean => "number" === typeof input.basis && (undefined === input.hardBounds || Array.isArray(input.hardBounds) && (input.hardBounds.length === 2 && "number" === typeof input.hardBounds[0] && "number" === typeof input.hardBounds[1])) && "boolean" === typeof input.coerce && ("object" === typeof input.runs && null !== input.runs && false === Array.isArray(input.runs) && _io4(input.runs)); const _io4 = (input: any): boolean => Object.keys(input).every((key: any) => {
    ...
    return true;
}); const _io5 = (input: any): boolean => (undefined === input.flow || "object" === typeof input.flow && null !== input.flow && _io6(input.flow)) && (undefined === input.cumulative_flow || "object" === typeof input.cumulative_flow && null !== input.cumulative_flow && _io6(input.cumulative_flow)) && (undefined === input.flow_bounds_relative || "object" === typeof input.flow_bounds_relative && null !== input.flow_bounds_relative && _io3(input.flow_bounds_relative)) && (undefined === input.cumulative_flow_bounds_relative || Array.isArray(input.cumulative_flow_bounds_relative) && (input.cumulative_flow_bounds_relative.length === 2 && "number" === typeof input.cumulative_flow_bounds_relative[0] && "number" === typeof input.cumulative_flow_bounds_relative[1])) && (undefined === input.peak_flow || Array.isArray(input.peak_flow) && (input.peak_flow.length === 3 && "number" === typeof input.peak_flow[0] && "number" === typeof input.peak_flow[1] && "number" === typeof input.peak_flow[2])); const _io6 = (input: any): boolean => "object" === typeof input.runs && null !== input.runs && false === Array.isArray(input.runs) && _io7(input.runs) && "number" === typeof input.basis; const _io7 = (input: any): boolean => Object.keys(input).every((key: any) => {
    const value = input[key];
    if (undefined === value)
        return true;
    if ("number" === typeof Number(key))
    ...
    return true;
}); const _io8 = (input: any): boolean => Object.keys(input).every((key: any) => {
    const value = input[key];
    if (undefined === value)
        return true;
    return "string" === typeof value || "number" === typeof value || "boolean" === typeof value;
}); const _io9 = (input: any): boolean => Object.keys(input).every((key: any) => {
    const value = input[key];
    if (undefined === value)
        return true;
    return true;
    ...
    expected: "(string | undefined)",
    value: input.type
}, _errorFactory)) && (undefined === input.attrs || ("object" === typeof input.attrs && null !== input.attrs && false === Array.isArray(input.attrs) || __typia_transform__assertGuard._assertGuard(_exceptionable, {
    method: "createAssert",
    path: _path + ".attrs",
    expected: "(IDeviceAttributes | undefined)",
    value: input.attrs
    ...
    expected: "Record<string, any>",
    value: input.parameters
}, _errorFactory)); const _ao2 = (input: any, _path: string, _exceptionable: boolean = true): boolean => (undefined === input.isSupply || "boolean" === typeof input.isSupply || __typia_transform__assertGuard._assertGuard(_exceptionable, {
    method: "createAssert",
    path: _path + ".isSupply",
...
}, _errorFactory)); const _ao3 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("number" === typeof input.basis || __typia_transform__assertGuard._assertGuard(_exceptionable, {
    method: "createAssert",
    path: _path + ".basis",
    expected: "number",
    value: input.basis
    ...
    expected: "([number, number, number] | undefined)",
    value: input.peak_flow
}, _errorFactory)); const _ao6 = (input: any, _path: string, _exceptionable: boolean = true): boolean => (("object" === typeof input.runs && null !== input.runs && false === Array.isArray(input.runs) || __typia_transform__assertGuard._assertGuard(_exceptionable, {
    method: "createAssert",
    path: _path + ".runs",
    ...
    expected: "number",
    value: input.basis
}, _errorFactory)); const _ao7 = (input: any, _path: string, _exceptionable: boolean = true): boolean => false === _exceptionable || Object.keys(input).every((key: any) => {
    const value = input[key];
    if (undefined === value)
        return true;
    if ("number" === typeof Number(key))
    ...
    if (undefined === value)
        return true;
    return true;
}); const __is = (input: any): input is IBusExport => "object" === typeof input && null !== input && false === Array.isArray(input) && _io0(input); let _errorFactory: any; return (input: any, errorFactory?: (p: import("typia").TypeGuardError.IProps) => Error): IBusExport => {
    if (false === __is(input)) {
...
export const assertEqualsIBus = (() => { const _iv1 = new Set([1, 2, 3, 4, 5, 6, 10, 15, 20, 30, 60]); const _av2 = new Set([1, 2, 3, 4, 5, 6, 10, 15, 20, 30, 60]); const _io0 = (input: any): boolean => "string" === typeof input.id && (undefined === input.parentId || "string" === typeof input.parentId) && "number" === typeof input.basis && true === _iv1.has(input.intervalMinutes) && "number" === typeof input.startIntervalOffset && (undefined === input.title || "string" === typeof input.title) && "string" === typeof input.type && ("object" === typeof input.attrs && null !== input.attrs && false === Array.isArray(input.attrs) && _io1(input.attrs)) && (undefined === input.description || "string" === typeof input.description) && (undefined === input.color || "string" === typeof input.color) && (undefined === input.shape || "string" === typeof input.shape) && (undefined === input.tags || "object" === typeof input.tags && null !== input.tags && false === Array.isArray(input.tags) && _io2(input.tags)); const _io1 = (input: any): boolean => (undefined === input.isSupply || "boolean" === typeof input.isSupply) && (undefined === input.hasParameters || "boolean" === typeof input.hasParameters) && (undefined === input.hideBounds || "boolean" === typeof input.hideBounds) && (undefined === input.hideCBounds || "boolean" === typeof input.hideCBounds) && (undefined === input.hideCosts || "boolean" === typeof input.hideCosts); const _io2 = (input: any): boolean => Object.keys(input).every((key: any) => {
    const value = input[key];
    if (undefined === value)
        return true;
    return "string" === typeof value || "number" === typeof value || "boolean" === typeof value;
    ...
    expected: "(Record<string, string | number | boolean> | undefined)",
    value: input.tags
}, _errorFactory)) && _ao2(input.tags, _path + ".tags", true && _exceptionable) || __typia_transform__assertGuard._assertGuard(_exceptionable, {
    method: "createAssert",
    path: _path + ".tags",
    expected: "(Record<string, string | number | boolean> | undefined)",
    value: input.tags
}, _errorFactory)); const _ao1 = (input: any, _path: string, _exceptionable: boolean = true): boolean => (undefined === input.isSupply || "boolean" === typeof input.isSupply || __typia_transform__assertGuard._assertGuard(_exceptionable, {
    method: "createAssert",
    path: _path + ".isSupply",
    expected: "(boolean | undefined)",
    value: input.isSupply
    ...
    expected: "(boolean | undefined)",
    value: input.hideCosts
}, _errorFactory)); const _ao2 = (input: any, _path: string, _exceptionable: boolean = true): boolean => false === _exceptionable || Object.keys(input).every((key: any) => {
    const value = input[key];
    if (undefined === value)
        return true;
    return "string" === typeof value || "number" === typeof value || "boolean" === typeof value || __typia_transform__assertGuard._assertGuard(_exceptionable, {
...
}); const __is = (input: any): input is IBus => "object" === typeof input && null !== input && _io0(input); let _errorFactory: any; return (input: any, errorFactory?: (p: import("typia").TypeGuardError.IProps) => Error): IBus => {
    if (false === __is(input)) {
        _errorFactory = errorFactory;
...
export const assertEqualsDeviceCosts = (() => { const _io0 = (input: any): boolean => (undefined === input.flow || "object" === typeof input.flow && null !== input.flow && _io1(input.flow)) && (undefined === input.cumulative_flow || "object" === typeof input.cumulative_flow && null !== input.cumulative_flow && _io1(input.cumulative_flow)) && (undefined === input.flow_bounds_relative || "object" === typeof input.flow_bounds_relative && null !== input.flow_bounds_relative && _io3(input.flow_bounds_relative)) && (undefined === input.cumulative_flow_bounds_relative || Array.isArray(input.cumulative_flow_bounds_relative) && (input.cumulative_flow_bounds_relative.length === 2 && "number" === typeof input.cumulative_flow_bounds_relative[0] && "number" === typeof input.cumulative_flow_bounds_relative[1])) && (undefined === input.peak_flow || Array.isArray(input.peak_flow) && (input.peak_flow.length === 3 && "number" === typeof input.peak_flow[0] && "number" === typeof input.peak_flow[1] && "number" === typeof input.peak_flow[2])); const _io1 = (input: any): boolean => "object" === typeof input.runs && null !== input.runs && false === Array.isArray(input.runs) && _io2(input.runs) && "number" === typeof input.basis; const _io2 = (input: any): boolean => Object.keys(input).every((key: any) => {
    const value = input[key];
    if (undefined === value)
        return true;
    if ("number" === typeof Number(key))
        return Array.isArray(value) && (value.length === 3 && "number" === typeof value[0] && "number" === typeof value[1] && "number" === typeof value[2]);
    return true;
}); const _io3 = (input: any): boolean => "number" === typeof input.basis && (undefined === input.hardBounds || Array.isArray(input.hardBounds) && (input.hardBounds.length === 2 && "number" === typeof input.hardBounds[0] && "number" === typeof input.hardBounds[1])) && "boolean" === typeof input.coerce && ("object" === typeof input.runs && null !== input.runs && false === Array.isArray(input.runs) && _io4(input.runs)); const _io4 = (input: any): boolean => Object.keys(input).every((key: any) => {
    const value = input[key];
    if (undefined === value)
        return true;
    if ("number" === typeof Number(key))
    ...
    expected: "([number, number, number] | undefined)",
    value: input.peak_flow
}, _errorFactory)); const _ao1 = (input: any, _path: string, _exceptionable: boolean = true): boolean => (("object" === typeof input.runs && null !== input.runs && false === Array.isArray(input.runs) || __typia_transform__assertGuard._assertGuard(_exceptionable, {
    method: "createAssert",
    path: _path + ".runs",
    expected: "Record<number, [number, number, number]>",
    value: input.runs
    ...
    return true;
}); const __is = (input: any): input is DeviceCosts => "object" === typeof input && null !== input && false === Array.isArray(input) && _io0(input); let _errorFactory: any; return (input: any, errorFactory?: (p: import("typia").TypeGuardError.IProps) => Error): DeviceCosts => {
    if (false === __is(input)) {
        _errorFactory = errorFactory;
        ((input: any, _path: string, _exceptionable: boolean = true) => ("object" === typeof input && null !== input && false === Array.isArray(input) || __typia_transform__assertGuard._assertGuard(true, {
            method: "createAssert",
...
export const assertEqualsIBaseDevice = (() => { const _iv1 = new Set([1, 2, 3, 4, 5, 6, 10, 15, 20, 30, 60]); const _av2 = new Set([1, 2, 3, 4, 5, 6, 10, 15, 20, 30, 60]); const _io0 = (input: any): boolean => "string" === typeof input.id && ("fixed_load" === input.type || "load" === input.type || "supply" === input.type || "storage" === input.type || "thermal_load" === input.type) && ("object" === typeof input.attrs && null !== input.attrs && false === Array.isArray(input.attrs) && _io1(input.attrs)) && (Array.isArray(input.hardBounds) && (input.hardBounds.length === 2 && "number" === typeof input.hardBounds[0] && "number" === typeof input.hardBounds[1])) && ("object" === typeof input.bounds && null !== input.bounds && _io2(input.bounds)) && (undefined === input.cumulative_bounds || "object" === typeof input.cumulative_bounds && null !== input.cumulative_bounds && _io2(input.cumulative_bounds)) && ("object" === typeof input.costs && null !== input.costs && false === Array.isArray(input.costs) && _io4(input.costs)) && "number" === typeof input.basis && true === _iv1.has(input.intervalMinutes) && "number" === typeof input.startIntervalOffset && (undefined === input.parentId || "string" === typeof input.parentId) && (undefined === input.title || "string" === typeof input.title) && (undefined === input.description || "string" === typeof input.description) && (undefined === input.tags || "object" === typeof input.tags && null !== input.tags && false === Array.isArray(input.tags) && _io7(input.tags)) && (undefined === input.color || "string" === typeof input.color) && (undefined === input.shape || "string" === typeof input.shape) && (undefined === input.parameters || "object" === typeof input.parameters && null !== input.parameters && false === Array.isArray(input.parameters) && _io8(input.parameters)); const _io1 = (input: any): boolean => (undefined === input.isSupply || "boolean" === typeof input.isSupply) && (undefined === input.hasParameters || "boolean" === typeof input.hasParameters) && (undefined === input.hideBounds || "boolean" === typeof input.hideBounds) && (undefined === input.hideCBounds || "boolean" === typeof input.hideCBounds) && (undefined === input.hideCosts || "boolean" === typeof input.hideCosts); const _io2 = (input: any): boolean => "number" === typeof input.basis && (undefined === input.hardBounds || Array.isArray(input.hardBounds) && (input.hardBounds.length === 2 && "number" === typeof input.hardBounds[0] && "number" === typeof input.hardBounds[1])) && "boolean" === typeof input.coerce && ("object" === typeof input.runs && null !== input.runs && false === Array.isArray(input.runs) && _io3(input.runs)); const _io3 = (input: any): boolean => Object.keys(input).every((key: any) => {
    const value = input[key];
    if (undefined === value)
        return true;
    if ("number" === typeof Number(key))
        return Array.isArray(value) && (value.length === 2 && "number" === typeof value[0] && "number" === typeof value[1]);
    return true;
}); const _io4 = (input: any): boolean => (undefined === input.flow || "object" === typeof input.flow && null !== input.flow && _io5(input.flow)) && (undefined === input.cumulative_flow || "object" === typeof input.cumulative_flow && null !== input.cumulative_flow && _io5(input.cumulative_flow)) && (undefined === input.flow_bounds_relative || "object" === typeof input.flow_bounds_relative && null !== input.flow_bounds_relative && _io2(input.flow_bounds_relative)) && (undefined === input.cumulative_flow_bounds_relative || Array.isArray(input.cumulative_flow_bounds_relative) && (input.cumulative_flow_bounds_relative.length === 2 && "number" === typeof input.cumulative_flow_bounds_relative[0] && "number" === typeof input.cumulative_flow_bounds_relative[1])) && (undefined === input.peak_flow || Array.isArray(input.peak_flow) && (input.peak_flow.length === 3 && "number" === typeof input.peak_flow[0] && "number" === typeof input.peak_flow[1] && "number" === typeof input.peak_flow[2])); const _io5 = (input: any): boolean => "object" === typeof input.runs && null !== input.runs && false === Array.isArray(input.runs) && _io6(input.runs) && "number" === typeof input.basis; const _io6 = (input: any): boolean => Object.keys(input).every((key: any) => {
    const value = input[key];
    if (undefined === value)
        return true;
    if ("number" === typeof Number(key))
    ...
    expected: "(boolean | undefined)",
    value: input.hideCosts
}, _errorFactory)); const _ao2 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("number" === typeof input.basis || __typia_transform__assertGuard._assertGuard(_exceptionable, {
    method: "createAssert",
    path: _path + ".basis",
    expected: "number",
    value: input.basis
    ...
    expected: "([number, number, number] | undefined)",
    value: input.peak_flow
}, _errorFactory)); const _ao5 = (input: any, _path: string, _exceptionable: boolean = true): boolean => (("object" === typeof input.runs && null !== input.runs && false === Array.isArray(input.runs) || __typia_transform__assertGuard._assertGuard(_exceptionable, {
    method: "createAssert",
    path: _path + ".runs",
    expected: "Record<number, [number, number, number]>",
    value: input.runs
    ...
    if (undefined === value)
        return true;
    return true;
}); const __is = (input: any): input is IBaseDevice => "object" === typeof input && null !== input && _io0(input); let _errorFactory: any; return (input: any, errorFactory?: (p: import("typia").TypeGuardError.IProps) => Error): IBaseDevice => {
    if (false === __is(input)) {
        _errorFactory = errorFactory;
        ((input: any, _path: string, _exceptionable: boolean = true) => ("object" === typeof input && null !== input || __typia_transform__assertGuard._assertGuard(true, {
            method: "createAssert",
...
export const assertEqualsIAllRunSpec = (() => { const _io0 = (input: any): boolean => "number" === typeof input.basis && ("object" === typeof input.runs && null !== input.runs && false === Array.isArray(input.runs) && _io1(input.runs)) && (undefined === input.hardBounds || Array.isArray(input.hardBounds) && (input.hardBounds.length === 2 && "number" === typeof input.hardBounds[0] && "number" === typeof input.hardBounds[1])) && (undefined === input.coerce || "boolean" === typeof input.coerce); const _io1 = (input: any): boolean => Object.keys(input).every((key: any) => {
    const value = input[key];
    if (undefined === value)
        return true;
    if ("number" === typeof Number(key))
    ...
    if ("number" === typeof Number(key))
        return true;
    return true;
}); const __is = (input: any): input is IAllRunSpec => "object" === typeof input && null !== input && _io0(input); let _errorFactory: any; return (input: any, errorFactory?: (p: import("typia").TypeGuardError.IProps) => Error): IAllRunSpec => {
    if (false === __is(input)) {
        _errorFactory = errorFactory;
        ((input: any, _path: string, _exceptionable: boolean = true) => ("object" === typeof input && null !== input || __typia_transform__assertGuard._assertGuard(true, {
            method: "createAssert",
