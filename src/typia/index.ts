...
export const assertEqualsDeviceCosts = (() => {
...
export const assertEqualsIBaseDevice = (() => {
...
export const assertEqualsIAllRunSpec = (() => {
...
export const assertIdentified = (() => {
    const _io0 = (input: any): boolean => "string" === typeof input.id; const _ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => "string" === typeof input.id || __typia_transform__assertGuard._assertGuard(_exceptionable, {
        method: "createAssert",
        path: _path + ".id",
        expected: "string",
        value: input.id
